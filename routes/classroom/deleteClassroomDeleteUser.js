 ...
 */
  const deleteClassroomDeleteUser = async function (req, res) {
    try {
      ...
      if (owner === classroom.creator) {
        ...
        const studentIndex = classroomStudents.findIndex(student => student._id.toString() === studentId);
        
        if (studentIndex !== -1) {
          // Remove the student from the array
          classroomStudents.splice(studentIndex, 1);
